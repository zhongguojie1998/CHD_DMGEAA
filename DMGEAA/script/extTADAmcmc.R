extTADAmcmc <- function(modelName  ,
                    ...
                    nThin = NULL, nThin2 = NULL, nCore = 4, nChain = 4,
                         hyperBetaDN0 = NULL,
                         hyperBetaCC0 = NULL,
                    ...
                    autoAdjustHyperBeta = FALSE)
     {
        ...
        if (is.null(hyper2GammaMeanCC) & !is.null(dataCCcase))
         ...
         if ((adjustHyperBeta == 0) & is.null( hyperBetaDN0))
             hyperBetaDN0 <- matrix(1, nrow = dim(dataDN)[1], ncol = dim(dataDN)[2])
         ...
         if (is.null(hyperBetaDN0)) hyperBetaDN0 <- matrix(1, nrow = dim(dataDN)[1], ncol = dim(dataDN)[2])
